<section class="section section--featured-services-condensed full-width"  style="background-color:<?php echo the_sub_field('background_color'); ?>" id="<?php echo the_sub_field('anchor')?>">
    <div class="section-wrapper">
        ...
        <div class="featured_slider_condensed">
